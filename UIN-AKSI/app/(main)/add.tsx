...
export default function AddTermScreen() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            Alert.alert('Terjadi Kesalahan', error.message || 'Gagal menyimpan data.');
        } finally {
            setLoading(false);
        }
    };
                ...
                <View style={styles.categoryContainer}>
                    {TERM_CATEGORIES.map((item) => (
                        <Pressable
                            ...
                            style={[
                                styles.categoryChip,
                                category === item.title && styles.categoryChipActive,
                            ]}
                        ...
                        >
                            <AppText
                                style={[
                                    styles.categoryText,
                                    category === item.title && styles.categoryTextActive,
                                ]}
                            >
                                {item.title}
                            </AppText>
